    ...
    <div class="container mt-5">
        ...
        <form action="form_hasil_nilai.php" method="post">
            <div class="mt-3 mb-3">
                ...
                <input type="number" name="nilai_uts" class="form-control" id="formGroupExampleInput" placeholder="Masukkan Nilai UTS Siswa">
            </div>
            <div class="mb-3">
                <label for="formGroupExampleInput2" class="form-label">Nilai UAS</label>
                <input type="number" name="nilai_uas" class="form-control" id="formGroupExampleInput2" placeholder="Masukkan Nilai UAS Siswa">
            </div>
            <div class="mb-3">
